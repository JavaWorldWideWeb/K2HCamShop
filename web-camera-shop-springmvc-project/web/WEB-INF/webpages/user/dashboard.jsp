                        ...
                        <div class="col-3" style="padding-top: 10px">
                            <div class="card"> <img src="${pageContext.request.contextPath}/image/${p.img}" class="card-img-top" width="100%" height="160vh">
                                <div class="card-body pt-0 px-0">
                                    ...
                                    <div class="mx-3 mt-3 mb-2"><a href="<c:url value="/cart/add/${p.productID}.html"/>" class="btn btn-warning btn-block"><small><b><i class="fas fa-shopping-cart"></i> THÊM VÀO GIỎ HÀNG</small></b></a></div> 
